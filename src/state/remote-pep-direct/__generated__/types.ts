...
export type ItemDetailsFragment = { __typename?: 'Item', id: any, gtin: string, price?: number | null, isOutOfStock?: boolean | null, inventoryQty?: number | null, compareAtPrice: number };
...
export type GetProductByGtinQuery = { __typename?: 'RootQueryType', itemByGtin?: { __typename?: 'Item', id: any, gtin: string, price?: number | null, isOutOfStock?: boolean | null, inventoryQty?: number | null, compareAtPrice: number } | null };
...
export const ItemsByGtinsDocument = gql`
...
/**
 * __useItemsByGtinsQuery__
 *
 * To run a query within a React component, call `useItemsByGtinsQuery` and pass it any options that fit your needs.
 * When your component renders, `useItemsByGtinsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useItemsByGtinsQuery({
 *   variables: {
 ...
 * });
 */
export function useItemsByGtinsQuery(baseOptions: Apollo.QueryHookOptions<ItemsByGtinsQuery, ItemsByGtinsQueryVariables> & ({ variables: ItemsByGtinsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>(ItemsByGtinsDocument, options);
      }
export function useItemsByGtinsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>(ItemsByGtinsDocument, options);
        }
export function useItemsByGtinsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>(ItemsByGtinsDocument, options);
        }
export type ItemsByGtinsQueryHookResult = ReturnType<typeof useItemsByGtinsQuery>;
export type ItemsByGtinsLazyQueryHookResult = ReturnType<typeof useItemsByGtinsLazyQuery>;
export type ItemsByGtinsSuspenseQueryHookResult = ReturnType<typeof useItemsByGtinsSuspenseQuery>;
export type ItemsByGtinsQueryResult = Apollo.QueryResult<ItemsByGtinsQuery, ItemsByGtinsQueryVariables>;
...
export const GetProductByGtinDocument = gql`
...
/**
 * __useGetProductByGtinQuery__
 *
 * To run a query within a React component, call `useGetProductByGtinQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductByGtinQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductByGtinQuery({
 *   variables: {
 *      gtin: // value for 'gtin'
 *   },
 * });
 */
export function useGetProductByGtinQuery(baseOptions: Apollo.QueryHookOptions<GetProductByGtinQuery, GetProductByGtinQueryVariables> & ({ variables: GetProductByGtinQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductByGtinQuery, GetProductByGtinQueryVariables>(GetProductByGtinDocument, options);
      }
export function useGetProductByGtinLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductByGtinQuery, GetProductByGtinQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductByGtinQuery, GetProductByGtinQueryVariables>(GetProductByGtinDocument, options);
        }
export function useGetProductByGtinSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetProductByGtinQuery, GetProductByGtinQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetProductByGtinQuery, GetProductByGtinQueryVariables>(GetProductByGtinDocument, options);
        }
export type GetProductByGtinQueryHookResult = ReturnType<typeof useGetProductByGtinQuery>;
export type GetProductByGtinLazyQueryHookResult = ReturnType<typeof useGetProductByGtinLazyQuery>;
export type GetProductByGtinSuspenseQueryHookResult = ReturnType<typeof useGetProductByGtinSuspenseQuery>;
export type GetProductByGtinQueryResult = Apollo.QueryResult<GetProductByGtinQuery, GetProductByGtinQueryVariables>;
...
export const UpdateCartItemMutationDocument = gql`
  ...
  updateCartItem(input: $input) {
    ...
    `;
export type UpdateCartItemMutationMutationFn = Apollo.MutationFunction<UpdateCartItemMutationMutation, UpdateCartItemMutationMutationVariables>;

/**
 * __useUpdateCartItemMutationMutation__
 *
 * To run a mutation, you first call `useUpdateCartItemMutationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCartItemMutationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateCartItemMutationMutation, { data, loading, error }] = useUpdateCartItemMutationMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateCartItemMutationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCartItemMutationMutation, UpdateCartItemMutationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCartItemMutationMutation, UpdateCartItemMutationMutationVariables>(UpdateCartItemMutationDocument, options);
      }
export type UpdateCartItemMutationMutationHookResult = ReturnType<typeof useUpdateCartItemMutationMutation>;
export type UpdateCartItemMutationMutationResult = Apollo.MutationResult<UpdateCartItemMutationMutation>;
export type UpdateCartItemMutationMutationOptions = Apollo.BaseMutationOptions<UpdateCartItemMutationMutation, UpdateCartItemMutationMutationVariables>;